...
abstract class LocaleKeys {
  ...
  static const owner_reports_amount = 'reports_amount';
  static const owner_reports_approvals = 'reports_approvals';
  static const owner_reports_total_approvals = 'reports_total_approvals';
  static const owner_reports_approved = 'reports_approved';
  static const owner_reports_pending = 'reports_pending';
  static const owner_reports_rejected = 'reports_rejected';
  static const owner_reports_approval_type = 'reports_approval_type';
  static const owner_reports_approval_date = 'reports_approval_date';
  ...
  static const authBrandName = auth_brand_name;
  static const authBrandSubtitle = auth_brand_subtitle;
  static const authLoginTitle = auth_login_title;
  static const authLoginSubtitle = auth_login_subtitle;
  static const authUsernameLabel = auth_username_label;
  static const authUsernameValidation = auth_username_validation;
  static const authPasswordLabel = auth_password_label;
  static const authPasswordValidation = auth_password_validation;
  static const authPasswordMinLength = auth_password_min_length;
  static const authRememberMe = auth_remember_me;
  static const authForgotPassword = auth_forgot_password;
  static const authLoginBtn = auth_login_btn;
  static const authVerifying = auth_verifying;
  static const authNoAccount = auth_no_account;
  static const authRegisterNew = auth_register_new;
  static const authCopyrights = auth_copyrights;
  static const authLoginSuccess = auth_login_success;
  static const authRequirePasswordChange = auth_require_password_change;
  static const dashboardWelcome = dashboard_welcome;
  static const dashboardDefaultUser = dashboard_default_user;
  static const dashboardTitle = dashboard_title;
  static const dashboardFinancialPosition = dashboard_financial_position;
  static const dashboardOverdue = dashboard_overdue;
  static const dashboardOverdueCount = dashboard_overdue_count;
  static const dashboardTotalDuePending = dashboard_total_due_pending;
  static const dashboardReceiptsThisMonth = dashboard_receipts_this_month;
  static const dashboardFinancialOverdues = dashboard_financial_overdues;
  static const dashboardOccupancyEfficiency = dashboard_occupancy_efficiency;
  static const dashboardOccupied = dashboard_occupied;
  static const dashboardVacant = dashboard_vacant;
  static const dashboardUnderMaint = dashboard_under_maint;
  static const dashboardReserved = dashboard_reserved;
  static const dashboardTotalUnits = dashboard_total_units;
  static const dashboardQuickActions = dashboard_quick_actions;
  static const dashboardAddProperty = dashboard_add_property;
  static const dashboardLeaseContract = dashboard_lease_contract;
  static const dashboardReceiptVoucher = dashboard_receipt_voucher;
  static const dashboardReports = dashboard_reports;
  static const dashboardMaintRequest = dashboard_maint_request;
  static const dashboardRecentReceipts = dashboard_recent_receipts;
  static const dashboardViewAll = dashboard_view_all;
  static const dashboardNoRecentReceipts = dashboard_no_recent_receipts;
  static const dashboardReceiptsSubtitle = dashboard_receipts_subtitle;
  static const dashboardUnitPrefix = dashboard_unit_prefix;
  static const dashboardNavHome = dashboard_nav_home;
  static const dashboardNavProperties = dashboard_nav_properties;
  static const dashboardNavContracts = dashboard_nav_contracts;
  static const dashboardNavFinance = dashboard_nav_finance;
  static const dashboardNavProfile = dashboard_nav_profile;
  ...
  static const profileOwnerBadge = profile_owner_badge;
  static const profileVerifiedAccount = profile_verified_account;
  static const profilePropertiesCount = profile_properties_count;
  static const profileUnitsCount = profile_units_count;
  static const profileContractsCount = profile_contracts_count;
  static const profileActiveSince = profile_active_since;
  static const profileBasicInfo = profile_basic_info;
  static const profilePersonalInfo = profile_personal_info;
  static const profileUsername = profile_username;
  static const profileEmail = profile_email;
  static const profilePhone = profile_phone;
  static const profileIdentitySection = profile_identity_section;
  static const profileAccountType = profile_account_type;
  static const profileAccountStatus = profile_account_status;
  static const profileActive = profile_active;
  static const profileInactive = profile_inactive;
  static const profileIdentityNumber = profile_identity_number;
  static const profileIdentityExpiry = profile_identity_expiry;
  static const profileAccountSettings = profile_account_settings;
  static const profileEditProfile = profile_edit_profile;
  static const profileEditProfileSubtitle = profile_edit_profile_subtitle;
  static const profileChangePassword = profile_change_password;
  static const profileChangePasswordSubtitle = profile_change_password_subtitle;
  static const profileLogout = profile_logout;
  static const profileLogoutSubtitle = profile_logout_subtitle;
  static const profileLogoutDialogMsg = profile_logout_dialog_msg;
  static const profileEditScreenTitle = profile_edit_screen_title;
  static const profileReadonlyBanner = profile_readonly_banner;
  static const profileFullNameLabel = profile_full_name_label;
  static const profileFullNameValidation = profile_full_name_validation;
  static const profilePhoneLabel = profile_phone_label;
  static const profilePhoneValidation = profile_phone_validation;
  static const profileGenderLabel = profile_gender_label;
  static const profileGenderMale = profile_gender_male;
  static const profileGenderFemale = profile_gender_female;
  static const profileSaveChanges = profile_save_changes;
  static const profileSaving = profile_saving;
  static const profileUpdateSuccess = profile_update_success;
  static const profileJoinedDate = profile_joined_date;
  static const profileGender = profile_gender;
  static const profileExpiringSoon = profile_expiring_soon;
  static const profileExpiryWarning = profile_expiry_warning;
  static const profileIdentityWarningBanner = profile_identity_warning_banner;
  static const profileCopiedTitle = profile_copied_title;
  static const profileCopySuccess = profile_copy_success;
  static const profileLoadError = profile_load_error;
  static const profileOwnerType = profile_owner_type;
  static const profileCompanyType = profile_company_type;
  static const profileTenantType = profile_tenant_type;
  static const profileUnspecified = profile_unspecified;
  static const profileContactAndAccountInfo = profile_contact_and_account_info;
  static const profileChangePasswordToast = profile_change_password_toast;
  static const profileChangePasswordTitle = profile_change_password_title;
  static const profileChangePasswordSub = profile_change_password_sub;
  static const profileChangePasswordCurrent = profile_change_password_current;
  static const profileChangePasswordNew = profile_change_password_new;
  static const profileChangePasswordConfirm = profile_change_password_confirm;
  static const profileChangePasswordBtn = profile_change_password_btn;
  ...
  static const profileAvatarSuccess = profile_avatar_success;
  static const profileReportsCenter = profile_reports_center;
  static const profileReportsCenterSubtitle = profile_reports_center_subtitle;
  static const commonRetry = common_retry;
  static const commonCurrencySar = common_currency_sar;
  static const commonSuccess = common_success;
  static const commonError = common_error;
  static const commonInfo = common_info;
  static const commonRooms = common_rooms;
  static const commonBathrooms = common_bathrooms;
  ...
  static const errorsLogoutFailed = errors_logout_failed;
  static const errorsNotLoggedIn = errors_not_logged_in;
  ...
  static const ownerExpiringTitle = owner_expiring_title;
  static const ownerExpiringSub = owner_expiring_sub;
  static const ownerPendingMaintTitle = owner_pending_maint_title;
  static const ownerPendingMaintSub = owner_pending_maint_sub;
  static const ownerHeaderSubtitle = owner_header_subtitle;
  static const ownerPropertiesTitle = owner_properties_title;
  static const ownerPropertiesSubtitle = owner_properties_subtitle;
  static const ownerReportsAmount = owner_reports_amount;
  static const ownerReportsApprovals = owner_reports_approvals;
  static const ownerReportsTotalApprovals = owner_reports_total_approvals;
  static const ownerReportsApproved = owner_reports_approved;
  static const ownerReportsPending = owner_reports_pending;
  static const ownerReportsRejected = owner_reports_rejected;
  static const ownerReportsApprovalType = owner_reports_approval_type;
  static const ownerReportsApprovalDate = owner_reports_approval_date;
  static const ownerPropertiesLog = owner_properties_log;
  static const ownerPropertiesPlaceholder = owner_properties_placeholder;
  static const ownerLeasesTitle = owner_leases_title;
  static const ownerLeasesSubtitle = owner_leases_subtitle;
  static const ownerLeasesLog = owner_leases_log;
  static const ownerLeasesPlaceholder = owner_leases_placeholder;
  static const ownerFinanceTitle = owner_finance_title;
  static const ownerFinanceSubtitle = owner_finance_subtitle;
  static const ownerFinanceLog = owner_finance_log;
  static const ownerFinancePlaceholder = owner_finance_placeholder;
  static const ownerMoreTitle = owner_more_title;
  static const ownerMoreSubtitle = owner_more_subtitle;
  static const ownerMoreQuickAccess = owner_more_quick_access;
  static const ownerMorePlaceholder = owner_more_placeholder;
  static const ownerMoreProfileCardTitle = owner_more_profile_card_title;
  static const ownerMoreProfileCardSub = owner_more_profile_card_sub;
  static const ownerCollected = owner_collected;
  static const ownerPending = owner_pending;
  static const ownerTotal = owner_total;
  static const ownerPillRented = owner_pill_rented;
  static const ownerPillVacant = owner_pill_vacant;
  static const ownerPillProperties = owner_pill_properties;
  static const ownerPillUnits = owner_pill_units;
  static const ownerFinanceOverviewTitle = owner_finance_overview_title;
  static const ownerFinanceNetCashFlow = owner_finance_net_cash_flow;
  static const ownerFinanceReceiptsTotal = owner_finance_receipts_total;
  static const ownerFinancePaymentsTotal = owner_finance_payments_total;
  static const ownerFinancePendingAlerts = owner_finance_pending_alerts;
  static const ownerFinancePendingReceipts = owner_finance_pending_receipts;
  static const ownerFinancePendingPayments = owner_finance_pending_payments;
  static const ownerFinancePendingTransfers = owner_finance_pending_transfers;
  static const ownerFinanceResourcesTitle = owner_finance_resources_title;
  static const ownerFinanceChartOfAccounts = owner_finance_chart_of_accounts;
  static const ownerFinanceReceiptVouchers = owner_finance_receipt_vouchers;
  ...
  static const ownerFinancePostJournalEntry = 'owner_finance_post_journal_entry';
  static const ownerFinancePostSuccess = 'owner_finance_post_success';
  static const ownerFinanceReverseJournalEntry = 'owner_finance_reverse_journal_entry';
  static const ownerFinanceReverseSuccess = 'owner_finance_reverse_success';
  static const ownerFinanceReverseConfirmTitle = 'owner_finance_reverse_confirm_title';
  static const ownerFinanceReverseConfirmMessage = 'owner_finance_reverse_confirm_message';
  static const ownerFinanceReverseReason = 'owner_finance_reverse_reason';
  static const ownerFinanceReverseReasonHint = 'owner_finance_reverse_reason_hint';
  static const ownerFinanceReverseReasonRequired = 'owner_finance_reverse_reason_required';

  static const commonCancel = 'common_cancel';
  static const ownerFinanceTransferDateRequired = 'owner_finance_transfer_date_required';
  ...
  static const ownerFinanceCancelPayment = owner_finance_cancel_payment;
  static const ownerFinanceCancelPaymentConfirmation = owner_finance_cancel_payment_confirmation;
  static const ownerFinanceCancelReasonLabel = owner_finance_cancel_reason_label;
  static const ownerFinanceCancelReasonHint = owner_finance_cancel_reason_hint;
  static const ownerFinanceCancelReasonError = owner_finance_cancel_reason_error;
  static const ownerFinanceCancelPaymentSuccess = owner_finance_cancel_payment_success;
  static const ownerFinancePaymentDetailsTitle = owner_finance_payment_details_title;
  static const ownerFinanceBasicInfo = owner_finance_basic_info;
  static const ownerFinancePaymentNumber = owner_finance_payment_number;
  static const ownerFinancePaymentDate = owner_finance_payment_date;
  static const ownerFinancePaymentMethod = owner_finance_payment_method;
  static const ownerFinanceNotes = owner_finance_notes;
  static const ownerFinanceAccountsTitle = owner_finance_accounts_title;
  static const ownerFinanceDebitAccount = owner_finance_debit_account;
  static const ownerFinanceCreditAccount = owner_finance_credit_account;
  static const ownerFinanceRelations = owner_finance_relations;
  static const ownerFinancePayee = owner_finance_payee;
  static const ownerFinancePropertyId = owner_finance_property_id;
  static const ownerFinanceContractId = owner_finance_contract_id;
  static const ownerFinanceJournalEntry = owner_finance_journal_entry;
  static const ownerFinanceJournalEntryNumber = owner_finance_journal_entry_number;
  static const ownerFinanceJournalEntryDate = owner_finance_journal_entry_date;
  static const ownerFinanceJournalEntryStatus = owner_finance_journal_entry_status;
  static const ownerFinanceTotalDebit = owner_finance_total_debit;
  static const ownerFinanceTotalCredit = owner_finance_total_credit;
  static const ownerFinanceTotalAmount = owner_finance_total_amount;
  ...
  static const propertiesFilterAll = properties_filter_all;
  static const propertiesFilterPublished = properties_filter_published;
  static const propertiesFilterDraft = properties_filter_draft;
  static const propertiesFilterArchived = properties_filter_archived;
  static const propertiesAddNew = properties_add_new;
  static const propertiesEmptyTitle = properties_empty_title;
  static const propertiesEmptySubtitle = properties_empty_subtitle;
  static const propertiesEmptyAction = properties_empty_action;
  static const propertiesSearchHint = properties_search_hint;
  static const propertiesCardUnits = properties_card_units;
  static const propertiesCardArea = properties_card_area;
  static const propertiesStatusPublished = properties_status_published;
  static const propertiesStatusDraft = properties_status_draft;
  static const propertiesStatusArchived = properties_status_archived;
  static const propertiesContinueDraft = properties_continue_draft;
  static const propertiesStatsTotal = properties_stats_total;
  static const propertiesStatsBuildings = properties_stats_buildings;
  static const propertiesStatsLands = properties_stats_lands;
  static const propertiesStatsUnitsDeeds = properties_stats_units_deeds;
  static const propertiesStatsDeeds = properties_stats_deeds;
  static const propertiesStatsUsages = properties_stats_usages;
  static const propertiesStatsResidential = properties_stats_residential;
  static const propertiesStatsMixed = properties_stats_mixed;
  static const propertiesDraftIncomplete = properties_draft_incomplete;
  static const propertiesDraftIncompleteDesc = properties_draft_incomplete_desc;
  static const propertiesDraftProgress = properties_draft_progress;
  static const propertiesDraftContinue = properties_draft_continue;
  static const propertyDetailsOverview = property_details_overview;
  static const propertyDetailsUnits = property_details_units;
  static const propertyDetailsBasicInfo = property_details_basic_info;
  static const propertyDetailsOwners = property_details_owners;
  static const propertyDetailsDeed = property_details_deed;
  static const propertyDetailsEdit = property_details_edit;
  static const propertyDetailsClone = property_details_clone;
  ...
  static const propertyEditTitle = property_edit_title;
  static const propertyEditSave = property_edit_save;
  static const propertyEditSuccess = property_edit_success;
  static const propertyEdit = property_edit;
  static const propertyCreateTitle = property_create_title;
  static const propertyCreateSubtitle = property_create_subtitle;
  static const propertyCreateSelectBranch = property_create_select_branch;
  static const propertyCreateSelectDeed = property_create_select_deed;
  static const propertyCreateSelectType = property_create_select_type;
  static const propertyCreateNoDeeds = property_create_no_deeds;
  ...
  static const propertyCreatePropertyName = property_create_property_name;
  static const propertyCreateAddress = property_create_address;
  static const propertyCreateArea = property_create_area;
  static const propertyCreateDescription = property_create_description;
  static const propertyCreateYearLabel = property_create_year_label;
  ...
  static const propertyCreate = property_create;
  static const propertyReviewTitle = property_review_title;
  static const propertyReviewSubtitle = property_review_subtitle;
  static const propertyReviewBranch = property_review_branch;
  static const propertyReviewDeed = property_review_deed;
  static const propertyReviewType = property_review_type;
  ...
  static const notificationsMarkAllRead = notifications_mark_all_read;
  static const notificationsAll = notifications_all;
  static const notificationsUnread = notifications_unread;
  ...
  static const notificationsTimeHoursAgo = notifications_time_hours_ago;
  static const notificationsTimeDaysAgo = notifications_time_days_ago;
  static const notificationsNoTitle = notifications_no_title;
  static const notificationsNoSubtitle = notifications_no_subtitle;
  static const contractsTitle = contracts_title;
  static const contractsTotalCount = contracts_total_count;
  static const contractsFilterAll = contracts_filter_all;
  static const contractsFilterActive = contracts_filter_active;
  static const contractsFilterExpiring = contracts_filter_expiring;
  static const contractsFilterDraft = contracts_filter_draft;
  static const contractsFilterTerminated = contracts_filter_terminated;
  static const contractsStatusActive = contracts_status_active;
  static const contractsStatusExpiring = contracts_status_expiring;
  static const contractsStatusDraft = contracts_status_draft;
  static const contractsStatusTerminated = contracts_status_terminated;
  static const contractsStatusCancelled = contracts_status_cancelled;
  static const contractsStatusRenewed = contracts_status_renewed;
  static const contractsStatusArchived = contracts_status_archived;
  static const contractsTenantLabel = contracts_tenant_label;
  static const contractsRentAmountLabel = contracts_rent_amount_label;
  static const contractsCycleMonthly = contracts_cycle_monthly;
  static const contractsCycleAnnual = contracts_cycle_annual;
  static const contractsCycleQuarterly = contracts_cycle_quarterly;
  static const contractsCycleCustom = contracts_cycle_custom;
  static const contractsNoContractsTitle = contracts_no_contracts_title;
  static const contractsNoContractsSubtitle = contracts_no_contracts_subtitle;
  static const contractsDetailsTitle = contracts_details_title;
  static const contractsContractNumberLabel = contracts_contract_number_label;
  static const contractsTypeLabel = contracts_type_label;
  static const contractsTypeResidential = contracts_type_residential;
  static const contractsTypeCommercial = contracts_type_commercial;
  static const contractsTypeLand = contracts_type_land;
  static const contractsTypeAdmin = contracts_type_admin;
  static const contractsEjarLinked = contracts_ejar_linked;
  static const contractsEjarNotLinked = contracts_ejar_not_linked;
  static const contractsSectionPropertyUnit = contracts_section_property_unit;
  static const contractsSectionRenter = contracts_section_renter;
  static const contractsRenterPhone = contracts_renter_phone;
  static const contractsActionCall = contracts_action_call;
  static const contractsActionWhatsapp = contracts_action_whatsapp;
  static const contractsSectionTimeline = contracts_section_timeline;
  static const contractsStartDateLabel = contracts_start_date_label;
  static const contractsEndDateLabel = contracts_end_date_label;
  static const contractsSectionFinancial = contracts_section_financial;
  static const contractsTotalRentValue = contracts_total_rent_value;
  static const contractsPaymentCount = contracts_payment_count;
  static const contractsPaymentCountUnit = contracts_payment_count_unit;
  static const contractsSecurityDeposit = contracts_security_deposit;
  ...
  static const maintenanceTotalCount = maintenance_total_count;
  static const maintenanceFilterAll = maintenance_filter_all;
  static const maintenanceFilterPending = maintenance_filter_pending;
  static const maintenanceFilterInProgress = maintenance_filter_in_progress;
  static const maintenanceFilterCompleted = maintenance_filter_completed;
  static const maintenanceFilterCancelled = maintenance_filter_cancelled;
  static const maintenanceStatusPending = maintenance_status_pending;
  static const maintenanceStatusApproved = maintenance_status_approved;
  static const maintenanceStatusInProgress = maintenance_status_in_progress;
  static const maintenanceStatusExecuted = maintenance_status_executed;
  static const maintenanceStatusRejected = maintenance_status_rejected;
  static const maintenanceStatusCancelled = maintenance_status_cancelled;
  static const maintenanceCostBearerLabel = maintenance_cost_bearer_label;
  static const maintenanceCostBearerClient = maintenance_cost_bearer_client;
  static const maintenanceCostBearerOwner = maintenance_cost_bearer_owner;
  static const maintenanceEstimatedCost = maintenance_estimated_cost;
  static const maintenanceActualCost = maintenance_actual_cost;
  static const maintenanceAdvancePayment = maintenance_advance_payment;
  static const maintenancePropertyLabel = maintenance_property_label;
  static const maintenanceUnitLabel = maintenance_unit_label;
  static const maintenanceRequestedDate = maintenance_requested_date;
  static const maintenanceScheduledDate = maintenance_scheduled_date;
  static const maintenanceCompletedDate = maintenance_completed_date;
  static const maintenanceNoRequestsTitle = maintenance_no_requests_title;
  static const maintenanceNoRequestsSubtitle = maintenance_no_requests_subtitle;
  static const maintenanceDetailsTitle = maintenance_details_title;
  static const maintenanceCostSection = maintenance_cost_section;
  static const maintenanceTimelineSection = maintenance_timeline_section;
  static const maintenanceImagesSection = maintenance_images_section;
  static const maintenanceNoImages = maintenance_no_images;
  static const maintenanceUnspecifiedDate = maintenance_unspecified_date;
  static const maintenanceNotDeterminedYet = maintenance_not_determined_yet;
  static const maintenanceNoTitle = maintenance_no_title;
  static const maintenanceNoSubtitle = maintenance_no_subtitle;
  static const revenueReportTitle = revenue_report_title;
  static const revenueExpected = revenue_expected;
  static const revenueCollected = revenue_collected;
  static const revenueOverdue = revenue_overdue;
  static const revenueCollectionRate = revenue_collection_rate;
  static const revenueTotalExpected = revenue_total_expected;
  static const revenueTotalCollected = revenue_total_collected;
  static const revenueNoData = revenue_no_data;
  static const revenueBarChartTitle = revenue_bar_chart_title;
  static const revenueMonthlyBreakdown = revenue_monthly_breakdown;
  static const occupancyReportTitle = occupancy_report_title;
  static const occupancyOverallRate = occupancy_overall_rate;
  static const occupancyPropertiesSection = occupancy_properties_section;
  static const occupancyUnnamedProperty = occupancy_unnamed_property;
  static const occupancyNoData = occupancy_no_data;
  static const defaultersReportTitle = defaulters_report_title;
  static const defaultersComingSoon = defaulters_coming_soon;
  static const defaultersEndpointPending = defaulters_endpoint_pending;
  static const drawerSettingsComingSoon = drawer_settings_coming_soon;
  static const drawerAppVersion = drawer_app_version;
  static const deedsTitle = deeds_title;
  static const deedsSubtitle = deeds_subtitle;
  static const deedsSearchHint = deeds_search_hint;
  static const deedsFilterAllBranches = deeds_filter_all_branches;
  static const deedsElectronicDeed = deeds_electronic_deed;
  static const deedsManualDeed = deeds_manual_deed;
  static const deedsPropertiesCountLabel = deeds_properties_count_label;
  static const deedsAreaLabel = deeds_area_label;
  static const deedsNoDeedsFound = deeds_no_deeds_found;
  static const deedsNoDeedsFoundSub = deeds_no_deeds_found_sub;
  static const deedsDocumentAttachment = deeds_document_attachment;
  static const deedsCreateDeed = deeds_create_deed;
  static const deedsDeedName = deeds_deed_name;
  static const deedsBranch = deeds_branch;
  static const deedsDocumentType = deeds_document_type;
  static const deedsDocumentNumber = deeds_document_number;
  static const deedsDocumentDate = deeds_document_date;
  static const deedsArea = deeds_area;
  static const deedsCity = deeds_city;
  static const deedsDistrict = deeds_district;
  static const deedsRegion = deeds_region;
  static const deedsStreetName = deeds_street_name;
  static const deedsBuildingNumber = deeds_building_number;
  static const deedsPostalCode = deeds_postal_code;
  static const deedsNotes = deeds_notes;
  static const deedsAttachment = deeds_attachment;
  static const deedsUploadAttachment = deeds_upload_attachment;
  static const deedsSave = deeds_save;
  static const deedsBasicInfo = deeds_basic_info;
  static const deedsLocationInfo = deeds_location_info;
  static const deedsDocumentInfo = deeds_document_info;
  static const deedsSuccessCreateDeed = deeds_success_create_deed;
  static const deedsRequiredField = deeds_required_field;
  static const deedsManagementSubtitle = deeds_management_subtitle;
  static const deedsCreateSubtitle = deeds_create_subtitle;
  static const deedsCancel = deeds_cancel;
  static const deedsDetailsTitle = deeds_details_title;
  static const deedsElectronic = deeds_electronic;
  static const deedsPaper = deeds_paper;
  static const deedsNumber = deeds_number;
  static const deedsDate = deeds_date;
  static const deedsPropertiesTitle = deeds_properties_title;
  static const propertyOwnersTitle = property_owners_title;
  static const propertyOwnersEditBtn = property_owners_edit_btn;
  static const propertyOwnersAddOwner = property_owners_add_owner;
  ...
  static const propertyOwnersAutoDistribute = property_owners_auto_distribute;
  ...
  static const propertyWizardStep3Title = property_wizard_step3_title;
  static const propertyWizardStep4Title = property_wizard_step4_title;
  static const propertyWizardStep5Title = property_wizard_step5_title;
  static const propertyWizardNext = property_wizard_next;
  ...
  static const propertyImagesAddPhoto = property_images_add_photo;
  static const propertyImagesNoImages = property_images_no_images;
  static const propertyImagesNoImagesSub = property_images_no_images_sub;
  static const propertyImagesUploading = property_images_uploading;
  static const propertyImagesUploadFailed = property_images_upload_failed;
  static const propertyImagesUploadSuccess = property_images_upload_success;
  static const propertyImagesSaveSuccess = property_images_save_success;
  static const propertyImagesAddDescription = property_images_add_description;
  static const propertyImagesDescriptionHint = property_images_description_hint;
  static const propertyImagesSaveDescription = property_images_save_description;
  static const propertyImages = property_images;
  static const unitDetailsTitle = unit_details_title;
  static const unitDetailsUnitType = unit_details_unit_type;
  static const unitDetailsUsageType = unit_details_usage_type;
  static const unitDetailsDimensions = unit_details_dimensions;
  static const unitDetailsLength = unit_details_length;
  static const unitDetailsWidth = unit_details_width;
  static const unitDetailsHeight = unit_details_height;
  static const unitDetailsFacadeLength = unit_details_facade_length;
  static const unitDetailsDirection = unit_details_direction;
  static const unitDetailsFinishingType = unit_details_finishing_type;
  static const unitDetailsMeters = unit_details_meters;
  static const unitDetailsElectricity = unit_details_electricity;
  static const unitDetailsWater = unit_details_water;
  static const unitDetailsGas = unit_details_gas;
  static const unitDetailsAmenities = unit_details_amenities;
  static const unitDetailsCurrentContract = unit_details_current_contract;
  static const unitDetailsEntrancesCount = unit_details_entrances_count;
  static const unitDetailsRentPrices = unit_details_rent_prices;
  static const unitDetailsPerTwoPayments = unit_details_per_two_payments;
  static const unitDetailsQuarterly = unit_details_quarterly;
  static const unitDetailsMonthly = unit_details_monthly;
  static const unitDetailsIsFurnished = unit_details_is_furnished;
  static const unitDetailsFurnished = unit_details_furnished;
  static const unitDetailsUnfurnished = unit_details_unfurnished;
  static const unitDetailsSpecs = unit_details_specs;
  static const unitDetailsContractInfo = unit_details_contract_info;
  static const unitDetailsBasicInfo = unit_details_basic_info;
  static const unitDetailsUnitCode = unit_details_unit_code;
  static const unitDetailsDescription = unit_details_description;
  static const unitDetailsStatusAvailable = unit_details_status_available;
  static const unitDetailsStatusRented = unit_details_status_rented;
  static const unitDetailsStatusReserved = unit_details_status_reserved;
  ...
  static const installmentsViewBtn = contracts_installments_view_btn;
  static const installmentsCountLabel = contracts_installments_count_label;
  ...
  static const deedDocumentAttachment = deeds_document_attachment;
  static const deedNumber = deeds_number;
  static const deedDate = deeds_date;
  static const deedArea = deeds_area;
  static const deedAreaUnit = deeds_area_label;
  static const deedBuildingNumber = deeds_building_number;
  static const deedStreetName = deeds_street_name;
  static const deedDistrict = deeds_district;
  static const deedCity = deeds_city;
  static const deedRegion = deeds_region;
  static const deedPostalCode = deeds_postal_code;
  static const deedNotes = deeds_notes;
  static const deedElectronic = deeds_electronic_deed;
  static const deedPaper = deeds_manual_deed;
  ...
  static const propertyDraftIncompleteDesc = properties_draft_incomplete_desc;
  static const propertyDraftProgress = properties_draft_progress;
  static const propertiesStatsUnitsAndDeeds = properties_stats_units_deeds;
  static const propertyOwnersAlreadyAdded = property_owners_owner_already_added;
  ...
  static const String maintenanceStartWork = 'maintenance.start_work';
  static const String maintenanceStartConfirmTitle = 'maintenance.start_confirm_title';
  static const String maintenanceStartConfirmDesc = 'maintenance.start_confirm_desc';
  static const String maintenanceStartSubmit = 'maintenance.start_submit';
  static const String maintenanceStartSuccess = 'maintenance.start_success';
  static const String maintenanceTaskCompleteTitle = 'maintenance.task_complete_title';
  static const String maintenanceTaskCompleteNotes = 'maintenance.task_complete_notes';
  static const String maintenanceTaskCompleteNotesHint = 'maintenance.task_complete_notes_hint';
  ...
  static const unitsAddNewUnit = 'units.add_new_unit';
  static const unitsAmenityAc = 'units.amenity_ac';
  static const unitsAmenityBalcony = 'units.amenity_balcony';
  static const unitsAmenityElevator = 'units.amenity_elevator';
  static const unitsAmenityInternet = 'units.amenity_internet';
  static const unitsAmenityKitchen = 'units.amenity_kitchen';
  static const unitsAmenityParking = 'units.amenity_parking';
  static const unitsAmenitySecurity = 'units.amenity_security';
  static const unitsAnnualRent2PaymentsHint = 'units.annual_rent2_payments_hint';
  static const unitsAnnualRent2PaymentsLabel = 'units.annual_rent_2_payments_label';
  static const unitsAnnualRent4PaymentsHint = 'units.annual_rent4_payments_hint';
  static const unitsAnnualRent4PaymentsLabel = 'units.annual_rent_4_payments_label';
  static const unitsAnnualRentMonthlyHint = 'units.annual_rent_monthly_hint';
  static const unitsAnnualRentMonthlyLabel = 'units.annual_rent_monthly_label';
  static const unitsAreaLabel = 'units.area_label';
  static const unitsAttachedImagesCount = 'units.attached_images_count';
  static const unitsBasicInfoTitle = 'units.basic_info_title';
  static const unitsBathrooms = 'units.bathrooms';
  static const unitsBathroomsCountLabel = 'units.bathrooms_count_label';
  static const unitsCity = 'units.city';
  static const unitsDimensionsOptional = 'units.dimensions_optional';
  static const unitsDistrict = 'units.district';
  static const unitsElectricityMeterHint = 'units.electricity_meter_hint';
  static const unitsElectricityMeterLabel = 'units.electricity_meter_label';
  static const unitsFacadeLengthLabel = 'units.facade_length_label';
  static const unitsFeatures = 'units.features';
  static const unitsFinancialsTitle = 'units.financials_title';
  static const unitsFinishingTypeFinished = 'units.finishing_type_finished';
  static const unitsFinishingTypeLabel = 'units.finishing_type_label';
  static const unitsFinishingTypeSemiFinished = 'units.finishing_type_semi_finished';
  static const unitsFinishingTypeWithout = 'units.finishing_type_without';
  static const unitsFloorNumberLabel = 'units.floor_number_label';
  static const unitsFloorTypeBasement = 'units.floor_type_basement';
  static const unitsFloorTypeGround = 'units.floor_type_ground';
  static const unitsFloorTypeLabel = 'units.floor_type_label';
  static const unitsFloorTypeRoof = 'units.floor_type_roof';
  static const unitsFloorTypeTypical = 'units.floor_type_typical';
  static const unitsGasMeterHint = 'units.gas_meter_hint';
  static const unitsGasMeterLabel = 'units.gas_meter_label';
  static const unitsHallsCountLabel = 'units.halls_count_label';
  static const unitsHeightLabel = 'units.height_label';
  static const unitsImagesCount = 'units.images_count';
  static const unitsImagesSubtitle = 'units.images_subtitle';
  static const unitsImagesTitle = 'units.images_title';
  static const unitsInternalDivision = 'units.internal_division';
  static const unitsIsFurnishedLabel = 'units.is_furnished_label';
  static const unitsKitchensCountLabel = 'units.kitchens_count_label';
  static const unitsLengthHint = 'units.length_hint';
  static const unitsLocationUtilsTitle = 'units.location_utils_title';
  static const unitsNo = 'units.no';
  static const unitsNone = 'units.none';
  static const unitsNotSpecified = 'units.not_specified';
  static const unitsPurposeLabel = 'units.purpose_label';
  static const unitsPurposeRent = 'units.purpose_rent';
  static const unitsPurposeSale = 'units.purpose_sale';
  static const unitsReviewSubtitle = 'units.review_subtitle';
  static const unitsReviewTitle = 'units.review_title';
  static const unitsRooms = 'units.rooms';
  static const unitsRoomsCountLabel = 'units.rooms_count_label';
  static const unitsSelectPrefix = 'units.select_prefix';
  static const unitsSpecsTitle = 'units.specs_title';
  static const unitsUnitAmenitiesLabel = 'units.unit_amenities_label';
  static const unitsUnitNameHint = 'units.unit_name_hint';
  static const unitsUnitNameLabel = 'units.unit_name_label';
  static const unitsUnitNameValidation = 'units.unit_name_validation';
  static const unitsUnitNumberHint = 'units.unit_number_hint';
  static const unitsUnitNumberLabel = 'units.unit_number_label';
  static const unitsUnitNumberValidation = 'units.unit_number_validation';
  static const unitsUnitTypeApartment = 'units.unit_type_apartment';
  static const unitsUnitTypeLabel = 'units.unit_type_label';
  static const unitsUnitTypeOffice = 'units.unit_type_office';
  static const unitsUnitTypeShop = 'units.unit_type_shop';
  static const unitsUnitTypeVilla = 'units.unit_type_villa';
  static const unitsUsageTypeCommercial = 'units.usage_type_commercial';
  static const unitsUsageTypeLabel = 'units.usage_type_label';
  static const unitsUsageTypeResidential = 'units.usage_type_residential';
  static const unitsUsePriceForMortgage = 'units.use_price_for_mortgage';
  static const unitsUsePriceForMortgageDesc = 'units.use_price_for_mortgage_desc';
  static const unitsWaterMeterHint = 'units.water_meter_hint';
  static const unitsWaterMeterLabel = 'units.water_meter_label';
  static const unitsWidthHint = 'units.width_hint';
  static const unitsWizardNext = 'units.wizard_next';
  static const unitsWizardPrevious = 'units.wizard_previous';
