...
import '../properties/presentation/cubit/property_finance/property_finance_cubit.dart';
import '../properties/presentation/cubit/unit_payments/unit_payments_cubit.dart';
...
void _initWarehouse() {
  ...
  if (!sl.isRegistered<CreateOwnerWarehouseItemUseCase>()) {
    sl.registerLazySingleton(() => CreateOwnerWarehouseItemUseCase(sl()));
  }
  if (!sl.isRegistered<OwnerWarehouseItemCreateCubit>()) {
    sl.registerFactory(
      () => OwnerWarehouseItemCreateCubit(createWarehouseItemUseCase: sl()),
    );
  }
  if (!sl.isRegistered<GetOwnerWarehouseItemDetailsUseCase>()) {
    sl.registerLazySingleton(() => GetOwnerWarehouseItemDetailsUseCase(sl()));
  }
  if (!sl.isRegistered<OwnerWarehouseItemDetailsCubit>()) {
    sl.registerFactory(
      () => OwnerWarehouseItemDetailsCubit(getDetailsUseCase: sl()),
    );
  }
  if (!sl.isRegistered<UpdateOwnerWarehouseItemUseCase>()) {
    sl.registerLazySingleton(() => UpdateOwnerWarehouseItemUseCase(sl()));
  }
...
void _initUnits() {
  ...
  if (!sl.isRegistered<UnitPaymentsCubit>()) {
    sl.registerFactory(() => UnitPaymentsCubit(sl()));
  }
}
...
void _initProperties() {
  ...
  if (!sl.isRegistered<PropertyFinanceCubit>()) {
    sl.registerFactory(() => PropertyFinanceCubit(sl()));
  }
...
void _initClients() {
  ...
  if (!sl.isRegistered<GetOwnerClientStatementUseCase>()) {
    sl.registerLazySingleton(() => GetOwnerClientStatementUseCase(sl()));
  }
  if (!sl.isRegistered<OwnerClientStatementCubit>()) {
    sl.registerFactory(() => OwnerClientStatementCubit(sl()));
  }
}
