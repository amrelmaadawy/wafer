...
class GetNegotiationFormDataUseCase implements UseCase<NegotiationFormDataEntity, NoParams> {
  final MaintenanceNegotiationRepository repository;

  GetNegotiationFormDataUseCase(this.repository);

  @override
  Future<Either<Failure, NegotiationFormDataEntity>> call(NoParams params) async {
