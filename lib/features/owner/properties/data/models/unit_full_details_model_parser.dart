...
UnitFullDetailsModel parseUnitFullDetails(Map<String, dynamic> json) {
    ...
    final tenantMap = json['tenant'] is Map<String, dynamic>
        ...
        : json['current_tenant'] is Map<String, dynamic>
    ...
    return UnitFullDetailsModel(
      id: json['id'] as int? ?? 0,
      propertyId: json['property_id'] as int? ?? propertyMap?['id'] as int? ?? 0,
      ...
      currentTenant: tenantMap != null ? UnitTenantModel.fromJson(tenantMap) : null,
