...
class DeedBranchModel extends DeedBranchEntity {
  const DeedBranchModel({required super.id, required super.name});
  ...
  factory DeedModel.fromJson(Map<String, dynamic> json) {
    return DeedModel(
      ...
      area: json['area'] is num
          ? json['area'] as num
          : num.tryParse(json['area'].toString()) ?? 0,
      ...
      branch: json['branch'] != null
          ? DeedBranchModel.fromJson(json['branch'])
          : null,
      propertiesCount: json['properties_count'] is int
          ? json['properties_count'] as int
          : int.tryParse(json['properties_count'].toString()) ?? 0,
      createdAt: json['created_at'] as String?,
      properties: json['properties'] != null
          ? (json['properties'] as List)
                .map((e) => DeedPropertyModel.fromJson(e))
                .toList()
          : const [],
    );
  }
