...
class ExecuteOwnerMaintenanceResponseModel
    extends ExecuteOwnerMaintenanceResponseEntity {
  const ExecuteOwnerMaintenanceResponseModel({
    required super.maintenanceRequest,
    required super.qaCode,
  });

  factory ExecuteOwnerMaintenanceResponseModel.fromJson(
    Map<String, dynamic> json,
  ) {
    return ExecuteOwnerMaintenanceResponseModel(
      maintenanceRequest: MaintenanceItemModel.fromJson(
