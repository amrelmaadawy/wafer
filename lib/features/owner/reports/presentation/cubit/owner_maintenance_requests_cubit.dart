...
class OwnerMaintenanceRequestsCubit
    extends Cubit<OwnerMaintenanceRequestsState> {
  final GetOwnerMaintenanceRequestsReportUseCase
  _getMaintenanceRequestsReportUseCase;
      ...
      (report) {
        if (report.items.isEmpty && _currentReport == null) {
          ...
          final hasReachedMax =
              _currentPage >= _currentReport!.pagination.lastPage;
          emit(
            OwnerMaintenanceRequestsLoaded(
              _currentReport!,
