...
class _LoginFormWidgetState extends State<LoginFormWidget> {
          ...
          child: Column(
            ...
            children: [
              _buildTextField(
                ...
                hint: LocaleKeys.authUsernameLabel.tr(),
                icon: Icons.person_outline_rounded,
                keyboardType: TextInputType.emailAddress,
                validator: (v) => (v == null || v.trim().isEmpty)
                    ? LocaleKeys.authUsernameValidation.tr()
                    : null,
              ),
  ...
  Widget _buildPasswordField(BuildContext context) => TextFormField(
    ...
    decoration: _inputDeco(
      context,
      hint: LocaleKeys.authPasswordLabel.tr(),
      ...
      DecoratedBox(
        decoration: BoxDecoration(
          ...
          gradient: isLoading
              ? null
              : LinearGradient(
                  colors: [context.primaryColor, context.primaryLight],
